...
namespace QlikGoogleCloudConnector
{
    ...
    {
        private QlikGoogleCloudConnectorServer _qvsos;
        ...
        {
            InitializeComponent();
            _qvsos = new QlikGoogleCloudConnectorServer();
        }
        ...
        private void generateButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    try
                    {
                        new QlikGoogleCloudConnectorServer().RunStandalone("", "StandalonePipe", _connectString, _sPath, query);
                    }
